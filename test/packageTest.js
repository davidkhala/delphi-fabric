...
describe('package', function () {
		...
		it('pack golang: diy packer is required for external chaincode', async () => {
			...
			const possible = [
				'diagnose:db2c2e31fc6294c1d324b6303510ad38185527119af4a1d3bf576b05a2bad38c',// CI
				Label + ':b3b9c7963a25754e6562d0be8c72f4b2dbdaca2203b82da36331a87cb4b2e0ea',// local test
			]
			assert.ok(possible.includes(binID));
