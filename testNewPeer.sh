...
docker container stop $peerContainerName
docker container rm $peerContainerName
rm -rf $newDir
...
docker container stop $chaincodeContainerPattern
docker container rm $chaincodeContainerPattern
#TODO 
