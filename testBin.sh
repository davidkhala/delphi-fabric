...
./common/bin-manage/configtxgen/runConfigtxgen.sh block create $BLOCK_FILE -v -p $PROFILE_BLOCK -i $config_dir -c $CHANNEL_ID
./common/bin-manage/configtxgen/runConfigtxgen.sh channel create $CHANNEL_FILE -v -p $PROFILE_CHANNEL -i $config_dir -c $CHANNEL_ID
