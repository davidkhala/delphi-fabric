 ...
 * @param {boolean} isTLS
 */
const setCAUser = (client, { username, orgName }, isTLS = false) => {
	...
	return caHelper.setCAAdmin(client, { orgName }, isTLS).then((adminUser) => {
...
const testInvoke = () => {
	...
	const orgName = 'BU'
	return setCAUser(client, { username: 'userB', orgName }, companyConfig.TLS).then(() => {
